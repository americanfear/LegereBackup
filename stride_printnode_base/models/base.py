...
class Base(models.AbstractModel):
    ...
    def run_printnode_universal_wizard(self):
        ...
        return {
            ...
            'view_mode': 'form',
            'view_id': self.env.ref('stride_printnode_base.printnode_attach_universal_wizard_form').id,
            'target': 'new',
    ...
    def run_printnode_print_reports_universal_wizard(self):
        ...
        return {
            ...
            'view_id': self.env.ref(
                'stride_printnode_base.printnode_print_reports_universal_wizard_form').id,
            'target': 'new',
            'context': self.env.context,
        }
