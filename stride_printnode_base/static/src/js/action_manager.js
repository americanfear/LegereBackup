...
function get_WKHTMLTOPDF_MESSAGES(env) {
    ...
    return {
        ...
        workers: env._t(
            "You need to start Stride with at least two workers to print a pdf version of " +
            "the reports."
        ),
    }
}
...
function _getWorkstationDevices() {
    ...
    for (let workstationDevice of WORKSTATION_DEVICES) {
        res[workstationDevice] = browser.localStorage.getItem('stride_printnode_base.' + workstationDevice);
    }
