...
export class PrintnodeStatusMenu extends Component {
    ...
    */
    ...
    get currentWorkstationId() {
        let workstationId = browser.localStorage.getItem('stride_printnode_base.workstation_id');
    ...
    setWorkstationDevice(e) {
        ...
        if (workstationId) {
            browser.localStorage.setItem('stride_printnode_base.workstation_id', workstationId);
            this.user.updateContext({ 'printnode_workstation_id': parseInt(workstationId) });
        } else {
            browser.localStorage.removeItem('stride_printnode_base.workstation_id');
